    ...
    <CustomTable
      ...
      renderTopToolbarCustomActions={() => (
        <Box display='flex' gap={2} alignItems='center' flexWrap='wrap'>
          ...
          {/* Acciones - Crear Entrada/Salida */}
          <Box display='flex' gap={1} marginLeft='auto'>
            {permissions.includes('inventory-movements.create') && (
              <>
                <Button
                  variant='contained'
                  color='success'
                  ...
                  onClick={() => {
                    // TODO: Implementar modal de crear entrada
                ...
                <Button
                  ...
                  onClick={() => {
                    // TODO: Implementar modal de crear salida
